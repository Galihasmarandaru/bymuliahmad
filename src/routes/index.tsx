    ...
    <main className="page-wrap px-4 pb-8 pt-14">
      <section className="island-shell rise-in relative overflow-hidden rounded-4xl px-6 py-10 sm:px-10 sm:py-14">
        ...
        <div className="flex flex-wrap gap-3">
          <a
            href="/about"
            className="rounded-full border border-(--line) bg-(--chip-bg) px-5 py-2.5 text-sm font-semibold text-(--lagoon-deep) no-underline transition hover:-translate-y-0.5 hover:bg-[rgba(79,184,178,0.24)]"
          >
            About This Starter
          </a>
          <a
      ...
      <section id="contact" className="island-shell rounded-2xl p-6 sm:p-8 mt-6">
        ...
        <p className="m-0 max-w-3xl text-base leading-8 text-(--sea-ink-soft)">
          Get in touch and let's discuss how I can help you achieve your business goals.
        </p>
      </section>
