...
function ParallaxSection({ src, children }: {
  src: string
      ...
      <section className="font-handwriting flex py-24 items-center justify-center bg-[#121212]">
        <div className="text-center w-2/3 px-10 space-y-12">
          ...
          <div className="mt-4 flex justify-center gap-4">
            <a href="https://www.instagram.com/muliadiahmad_/"
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <svg viewBox="0 0 24 24" aria-hidden="true" width="32" height="32" fill="none">
                <rect x="2" y="2" width="20" height="20" rx="5.5" ry="5.5" stroke="currentColor" strokeWidth="1.8" />
                <circle cx="12" cy="12" r="4.3" stroke="currentColor" strokeWidth="1.8" />
                <circle cx="17.5" cy="6.5" r="1.1" fill="currentColor" />
              </svg>
            </a>
            <a href="https://wa.me/6285642506093"
              target="_blank"
              rel="noreferrer"
              className="rounded-xl p-2 text-(--sea-ink-soft) transition hover:bg-(--link-bg-hover) hover:text-(--sea-ink)"
            >
              <span className="sr-only">Go to WhatsApp</span>
              <svg viewBox="0 0 24 24" aria-hidden="true" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
                <path fill="currentColor" fill-rule="evenodd" clip-rule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 1.938.551 3.746 1.505 5.279L2 22l4.823-1.487A9.948 9.948 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2zM12 20.182a8.172 8.172 0 01-4.162-1.138l-.298-.177-3.087.884.879-3.178-.194-.308A8.182 8.182 0 1112 20.182zM9.04 7.847c-.198-.44-.407-.449-.595-.457L7.89 7.38c-.176 0-.462.066-.703.33-.242.264-.924.903-.924 2.202s.945 2.554 1.077 2.73c.132.176 1.847 2.957 4.537 4.023.634.274 1.129.437 1.514.56.636.202 1.215.174 1.673.105.51-.076 1.571-.642 1.793-1.262.22-.62.22-1.15.154-1.261-.066-.11-.242-.176-.506-.308-.264-.132-1.562-.77-1.804-.858-.242-.088-.418-.132-.594.132-.176.264-.682.858-.836 1.034-.154.176-.308.198-.572.066-.264-.132-1.116-.411-2.126-1.312-.787-.701-1.317-1.567-1.471-1.831-.154-.264-.016-.407.116-.538.12-.119.264-.309.396-.463.133-.154.177-.264.265-.44.088-.176.044-.33-.022-.462-.066-.132-.581-1.436-.813-1.963z" />
              </svg>
            </a>
          </div>
        </div>
